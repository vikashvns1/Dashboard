...
namespace SynGeniee
{
    public static class StaticDataSource
    {
        ...
        public static ObservableCollection<CompanyProfile> AdminData { get; set; }
        ...
        public static ObservableCollection<MenuItem> MenuItemList { get; set; }
        ...
        public static int  NewNotificationCount { get; set; }
        public static List<DbNotification> DbNotificationList { get; set; }
        public static ObservableCollection<DbConnection> DbConnectionList { get; set; }
